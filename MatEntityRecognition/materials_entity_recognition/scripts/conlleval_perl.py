...
# def countChunks(fileIterator, args):
    ...
    for line in fileIterator:
        ...
        # we cannot use strip() directly because some non-sapce special character might be strip out
        features = re.split(delimiter, line.strip(' \t\n'))
        # split might produce emtpy strings
